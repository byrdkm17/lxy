KM.addMod(function() {
    var self = KM.mod('other.calendar', true);
    ...
    var fn = {
        loadData: function(url, params, callback, region) {
            ...
            url = url || self.path + 'json.asp?action=calendar';
            url += '&_dc=' + +new Date();
            params = params || {};
        ...
        postData: function(url, params, callback, region) {
            ...
            url = url || self.path + 'do.asp?action=calendar';
            region = region || w;
        ...
        render: function(data) {
            ...
            $.each(data, function() {
                $tbody.append(tpl.calendar.tr.render(this));
        ...
        editClick: function() {
            ...
            fn.loadData(false, {edit: 1, id: $tr.data('source').id}, function(data) {
                $.ajax(self.path + 'json?action=calendar&_dc=' + +new Date(), {
