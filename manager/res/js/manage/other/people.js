KM.addMod(function() {
    var self = KM.mod('other.people', true);
    ...
    var fn = {
        loadData: function(url, params, callback, region) {
            ...
            url = url || self.path + 'json.asp?action=people';
            url += '&_dc=' + +new Date();
            params = params || {};
        ...
        postData: function(url, params, callback, region) {
            ...
            url = url || self.path + 'do.asp?action=people';
            region = region || w;
        ...
        render: function(data) {
            ...
            $.each(data, function() {
                $tbody.append(tpl.people.tr.render(this));
        ...
        editClick: function() {
            ...
            fn.loadData(false, {edit: 1, id: $tr.data('source').id}, function(data) {
                $.ajax(self.path + 'json?action=people&_dc=' + +new Date(), {
